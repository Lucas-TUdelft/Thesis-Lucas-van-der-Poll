...
class ApolloGuidance:
    ...
    def __init__(self, ref_data: apollo_utils.ApolloReferenceData,
        ...
        self.ground_station_latitude = self.ground_station.station_state.geodetic_positon[1]
        self.ground_station_longitude = self.ground_station.station_state.geodetic_positon[2]
