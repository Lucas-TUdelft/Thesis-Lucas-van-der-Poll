...
class ApolloGuidance:
    ...
    def __init__(self, ref_data: apollo_utils.ApolloReferenceData,
        ...
        self.ground_station_latitude = self.ground_station.station_state.geodetic_position_positon_at_reference_epoch[1]
        self.ground_station_longitude = self.ground_station.station_state.geodetic_position_positon_at_reference_epoch[2]
