...
k = 1.83 * 10**(-4)
R_n = 1.861 # m
heatflux = k * np.sqrt(rho / R_n) * v_3
max_heatflux = max(heatflux)
total_heatload = np.trapz(heatflux)
final_groudstation_position_bodyfixed = bodies.get_body("Earth").get_ground_station("LandingPad").station_state.get_cartesian_position(0.0)
...
final_groudstation_position_bodyfixed = bodies.get_body("Earth").get_ground_station("LandingPad").station_state.get_cartesian_position(0.0)
final_groudstation_position_bodyfixed_unit = final_groudstation_position_bodyfixed / np.linalg.norm(final_groudstation_position_bodyfixed)
...
# calculate delta-V
print(initial_cartesian_state_inertial_disconnect, initial_cartesian_state_inertial, initial_cartesian_state_inertial_disconnect - initial_cartesian_state_inertial)
initial_velocity_correction = (initial_cartesian_state_inertial_disconnect - initial_cartesian_state_inertial)[3:6]
