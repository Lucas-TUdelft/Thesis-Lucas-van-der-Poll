...
def get_propagator_settings(shape_parameters,
    ...
    if model_choice == 1:
        acceleration_settings_on_vehicle = {
            'Earth': [propagation_setup.acceleration.spherical_harmonic_gravity(20, 20),
                      propagation_setup.acceleration.aerodynamic()],
            'Moon': [propagation_setup.acceleration.point_mass_gravity()],
            'Sun': [propagation_setup.acceleration.point_mass_gravity()]
        }
    ...
    if model_choice == 1:
        reference_area_radiation = 60.82 # m^2
        ...
        environment_setup.add_radiation_pressure_target_model(
            bodies, 'Capsule', vehicle_target_settings
        )
    ...
    if model_choice == 2:
        reference_area_radiation = 60.82 # m^2
        radiation_pressure_coefficient = 2.0 # -
        occulting_bodies_dict = dict()
        occulting_bodies_dict['Sun'] = ['Earth']
        vehicle_target_settings = environment_setup.radiation_pressure.cannonball_radiation_target(
            reference_area_radiation, radiation_pressure_coefficient, occulting_bodies_dict
